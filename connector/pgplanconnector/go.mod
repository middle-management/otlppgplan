module github.com/middle-management/otlppgplan/connector/pgplanconnector
...
require (
	github.com/middle-management/otlppgplan v0.0.0
...
replace github.com/middle-management/otlppgplan => ../..
